...
public static class AssistantBrokerProtocol
{
    ...
    public const string PipeName = "TaskbarBuddy.AssistantBroker.v2";
...
public sealed class AssistantSessionBrokerClient : IStoredAssistantSessions
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return pipe is null
            ? throw new IOException("Could not connect to the Taskbar Buddy assistant broker.")
    ...
    private static string PrepareBrokerExecutable(string executablePath)
    {
        ...
        [
            executablePath,
            Path.Combine(sourceDirectory, "TaskbarBuddy.Composition.dll"),
            Path.Combine(sourceDirectory, "TaskbarBuddy.Core.dll"),
            Path.Combine(sourceDirectory, "TaskbarBuddy.Copilot.dll")
        ];
